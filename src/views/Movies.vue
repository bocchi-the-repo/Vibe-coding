...
export default defineComponent({
  ...
  setup() {
    const following = ref<Item[]>([
      { id: 2, title: 'Midnight Run', year: 2021, genre: 'Thriller' }
    ])

    const recs = ref<Item[]>([
      { id: 21, title: 'Lost Horizon', year: 2023, genre: 'Drama' },
      { id: 22, title: 'City Lights', year: 2024, genre: 'Romance' },
      { id: 23, title: 'Nightfall', year: 2022, genre: 'Horror' }
    ])
